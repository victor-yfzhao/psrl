...
class StatCollector(StatLoggerBase):
    ...
    def __init__(
        ...
        pivotrl_logger.info(f"Enhanced StatCollector initialized, engine {self.engine_index}")
        pivotrl_logger.info(f"Profile logs will be saved to: {self.log_file}")
    ...
    def _clear_log_file(self):
        ...
        try:
            if self.log_file.exists():
                ...
                pivotrl_logger.info(f"Cleared existing log file: {self.log_file}")
        except Exception as e:
            pivotrl_logger.warning(f"Failed to clear log file {self.log_file}: {e}")
    ...
    def _write_log_entry(self, entry: dict[str, Any]):
        ...
        try:
            ...
            pivotrl_logger.error(f"Failed to write log entry: {e}")
