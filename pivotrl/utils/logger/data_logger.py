...
def log_data_protocol(
    ...
    pivotrl_logger.log(level, f"[{log_prefix}]: tensor batch have {input_tensor_types}")
    pivotrl_logger.log(level, f"[{log_prefix}]: non tensor batch have {input_non_tensor_types}")
