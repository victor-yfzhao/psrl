"""
Worker naming utilities for PivotRL.
...
NIXL name string constants are imported from pivotrl.utils.common.nixl_names.
"""
...
from pivotrl.utils.common.nixl_names import (
...
class WorkerKey:
    """
    Structured identifier for a single PivotRL worker.
