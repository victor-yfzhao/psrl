...
from pivotrl.utils.common.utils import lazy_import_many_to_globals, lazy_import_to_globals
...
if TYPE_CHECKING:
    ...
    from pivotrl.utils.megatron.router_replay_patch import (
        RouterReplay,
        RouterReplayAction,
    )
...
class PivotRL_MegatronTrainWorker(ActorRolloutRefWorker, PivotRL_BaseTrainWorker):
    def __init__(
        self,
        config: DictConfig,
        role: str,
    ...
    def nixl_convert_params(self):
        ...
        lazy_import_to_globals("pivotrl.utils.converter.megatron_converter", "convert_megatron_inplace")
    ...
    def _restore_non_persistent_buffers_from_ps(self) -> None:
        ...
        if not inv_freq_tensors:
            pivotrl_logger.warning("[_restore_non_persistent_buffers_from_ps] No inv_freq found in PS buffers.")
            return
