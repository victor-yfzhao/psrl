...
from pivotrl.utils.logger import get_ps_logger
...
class StalenessInventory:
    ...
    def __init__(
        ...
        if self.is_validate:
            if self.staleness:
                self.staleness = None
                pivotrl_logger.warning("Validation inventory must have staleness=None, setting staleness to None.")
    ...
    def create_buffer(self, buffer_id: int):
        ...
        pivotrl_logger.info(f"[Buffer Create]: buffer {buffer_id} created, current buffer IDs: {self.buffers.keys()}")
    ...
    def delete_buffer(self, buffer_id: int):
        ...
        pivotrl_logger.debug(f"[Buffer Delete]: buffer {buffer_id} deleted, current buffer IDs: {self.buffers.keys()}")
    ...
    def reserve_data(
        ...
        if self.is_validate and max_staleness_buffer_id is not None:
            ...
            pivotrl_logger.warning("Validation inventory must have max_staleness_buffer_id=None, setting it to None.")
    ...
    def clear_reserved_entries(
        ...
        if self.is_validate and move_across_buffer:
            ...
            pivotrl_logger.warning("Validation inventory must have move_across_buffer=False, setting it to False.")
