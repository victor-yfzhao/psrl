...
from pivotrl.utils.common.http_utils import init_http_client
from pivotrl.utils.dataset.utils import _pre_process_inputs
from pivotrl.utils.logger import DualOutputHandler, EventType, log_dual_events
from pivotrl.utils.rollout.rollout_trace import RolloutTraceConfig, rollout_trace_attr
from pivotrl.workers.agent_loop.loops.utils import AGENT_LOOP_REGISTRY, DummyConfig, TerminateReason
...
class PivotRL_AgentLoopWorker:
    ...
    def __init__(
        ...
        if self.config.pivotrl.server_rollout.enable:
            ...
            init_http_client(
                server_concurrency=self.config.pivotrl.server_rollout.server_concurrency,
    ...
    def _create_task_done_callback(self, task):
        ...
        def task_done_callback(future):
            try:
                ...
                pivotrl_logger.error(f"Task {task} failed with exception: {e}")
            finally:
            ...
            if output is not None:
                ...
                with log_dual_events(
                    ...
                    update_status_success = await self.ps_manager_handle.update_request_status.remote(
                        request_ids.tolist(),
                        PivotRL_RequestStatus.COMPLETED,
