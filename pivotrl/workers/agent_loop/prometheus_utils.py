...
from pivotrl.workers.config.rollout import PrometheusConfig
...
def update_prometheus_config(config: PrometheusConfig, server_addresses: list[str]):
    ...
    if not server_addresses:
        pivotrl_logger.warning("No server addresses available to update Prometheus config")
        return
    ...
    try:
        ...
        pivotrl_logger.error(f"Failed to update Prometheus configuration: {e}")
