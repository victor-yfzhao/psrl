...
from pivotrl.utils.nixl import NIXLInterface
from pivotrl.workers.gen import GenInterface

pivotrl_logger = logging.getLogger(__file__)
pivotrl_logger.setLevel(os.getenv("PIVOTRL_LOGGING_LEVEL", "WARN"))


class PivotRL_VerlGenWorker(ActorRolloutRefWorker):
    def __init__(
        self,
        config: DictConfig,
        role: str,
        ...
        **kwargs,
        ...
        """
        Initialize the PivotRL FSDP GenWorker.
    ...
    def ray_pull_model(self) -> None:
        ...
        if self.pivotrl_config.ps_mode == "cpu" or self.pivotrl_config.ps_mode == "cpu_ref":
            ...
            raise NotImplementedError(f"PivotRL VerlGenWorker does not support PS mode '{self.pivotrl_config.ps_mode}' yet.")
