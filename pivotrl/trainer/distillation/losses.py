...
from pivotrl.workers.config import ActorConfig, DistillationConfig, DistillationLossConfig
...
def compute_topk_loss(
    ...
    match config.strategy:
        case "fsdp":
            import pivotrl.trainer.distillation.fsdp.losses as fsdp_losses

            distillation_loss_fn = fsdp_losses.compute_forward_kl_topk
        case "megatron":
            import pivotrl.trainer.distillation.megatron.losses as megatron_losses
