...
class ResourcePoolManager:
    ...
    mapping: dict[PivotRL_Role, list[str]]
    ...
    def get_resource_pool(self, role: PivotRL_Role, instance_id: int = 0) -> RayResourcePool:
...
class PivotRL_DummyWorker(Worker):
...
def need_reference_policy(
    ...
    return PivotRL_Role.RefPolicy in role_worker_mapping
...
def need_reward_model(
    ...
    return PivotRL_Role.RewardModel in role_worker_mapping
