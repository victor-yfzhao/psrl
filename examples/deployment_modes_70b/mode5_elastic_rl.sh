...
export PIVOTRL_DEPLOY_EXPERIMENT=mode5_overhead_bs_128_share_32_elastic_rl
...
+reward_models_config.reward_models.2.routing_strategy.cost_model_path=/apdcephfs_zwfy10/share_303541817/yfzhao/pivotrl/pivotrl/trainer/config/cost_model/qwen3.5_122b_a10b.json \
