...
TRAIN_POOL_GPUS=16
IDLE_GPU_DEMAND=$((IDLE_ROLLOUT_INSTANCES * PIVOTRL_DEPLOY_ROLLOUT_TP + IDLE_RM_INSTANCES * PIVOTRL_DEPLOY_RM_TP))
...
export PIVOTRL_DEPLOY_EXPERIMENT=mode4_bs_128_roll_8_rm_4_trainer_pool_only
