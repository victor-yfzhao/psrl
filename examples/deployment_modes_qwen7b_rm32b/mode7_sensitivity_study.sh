...
export PSRL_DEPLOY_EXPERIMENT="mode7_sensitivity_study_decision_window_${DECISION_WINDOW_S}"
...
psrl.deployment.elastic_rm.itl_policy.decision_window_s=${DECISION_WINDOW_S} \
