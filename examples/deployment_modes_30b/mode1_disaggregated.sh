...
export PIVOTRL_DEPLOY_TRAIN_BACKEND=${PIVOTRL_DEPLOY_TRAIN_BACKEND:-${TRAIN_BACKEND:-megatron}}
...
export PIVOTRL_DEPLOY_RM_NUM_REPLICAS=2
export PIVOTRL_DEPLOY_SMOKE=${1:-1}
shift || true
