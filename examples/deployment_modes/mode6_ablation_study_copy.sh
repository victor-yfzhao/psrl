#!/usr/bin/env bash
# Mode 6 — elastic RL ablation on the Qwen2.5-1.5B (TP1) + GLM-Z1-9B-0414 (TP1)
...
#     bash mode6_ablation_study_copy.sh [smoke_test=0] [extra hydra overrides...]
set -euo pipefail
...
RM_COST_MODEL="${COST_MODEL_DIR}/glm_z1_9b_0414.json"
