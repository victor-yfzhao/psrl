...
class RolloutCorrectionConfig(BaseConfig):
    ...
    rollout_rs_threshold: float | None = None
    rollout_rs_threshold_lower: float | None = None
    rollout_token_veto_threshold: float | None = None
    ...
    def decoupled_seq_is_rs(
        ...
        rs_threshold_lower: float | None = None,
    ...
    def geo_rs_seq_tis(
        ...
        rs_threshold: float = 1.001,
        rs_threshold_lower: float | None = None,
        veto_threshold: float | None = 1e-4,
    ) -> "RolloutCorrectionConfig":
...
class AlgoConfig(BaseConfig):
    ...
    Args:
        ...
        adv_estimator (str): Advantage estimator type: "gae", "grpo", "gigpo", "reinforce_plus_plus", etc.
        norm_adv_by_std_in_grpo (bool): Whether to normalize advantages by std (specific to GRPO).
        gigpo_step_advantage_weight (float): Weight for GiGPO step-level advantages in
            A_episode + weight * A_step.
    ...
    gigpo_step_advantage_weight: float = 1.0
